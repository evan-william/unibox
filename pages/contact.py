    ...
    with col2:
        ...
        st.html("""
            <div class='tool-card' style='height: 100%;'>
                <h2 style='font-size: 28px; margin-bottom: 2rem; color: #ff4757;'>Contact Information</h2>
                
                <!-- Email Section -->
                <div style='margin-bottom: 2.5rem;'>
                    <div style='display: flex; align-items: center; gap: 12px; margin-bottom: 0.75rem;'>
                        <div style='width: 40px; height: 40px; background: linear-gradient(135deg, #2d2d2d 0%, #262626 100%); 
