            ...
            <div class='contact-info-container'>
                ...
                <div class='contact-section'>
                    ...
                    <div class='contact-detail'>
                        <p class='contact-text'>support@unibox.com</p>
                        <p class='contact-subtext'>Response time: 24-48 hours</p>
                    </div>
                </div>
                ...
                <div class='contact-section'>
                    <div class='contact-header'>
                        <div class='icon-box'>
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M21 10C21 17 12 23 12 23C12 23 3 17 3 10C3 5.02944 7.02944 1 12 1C16.9706 1 21 5.02944 21 10Z" stroke="#ff4757" stroke-width="2"/>
                    ...
                    <div class='contact-detail'>
                        <p class='contact-text'>Jakarta, Indonesia</p>
                        <p class='contact-subtext'>Remote-first company</p>
                    </div>
                </div>
                
                <!-- Social Media Section -->
                <div class='social-section'>
                    <h4 class='contact-label' style='margin-bottom: 1rem;'>Follow Us</h4>
